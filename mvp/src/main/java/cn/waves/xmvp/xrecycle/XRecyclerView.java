...
import cn.waves.xmvp.xrecycle.divider.HorizontalDividerItemDecoration;
import cn.waves.xmvp.xrecycle.divider.VerticalDividerItemDecoration;
...
public class XRecyclerView extends RecyclerView {
    ...
    private void setSpanLookUp(LayoutManager layoutManager, final int spanCount) {
    ...
    OnScrollListener processMoreListener = new OnScrollListener() {
